...
//        Color backColor = new Color(91, 157, 171);
//        //判断滚动条是垂直的 还是水平的
//
...
//            //设置画笔
//
//            gp = new GradientPaint(0, 0, backColor,
//
//                    trackBounds.width, 0, backColor);
//
//        }
//
//        if (this.scrollbar.getOrientation() == JScrollBar.HORIZONTAL) {
//            gp = new GradientPaint(0, 0, backColor, trackBounds.height, 0, backColor);
//        }
//
//
//        g2.setPaint(gp);
...
//        // 设置把手颜色
//
//        g.setColor(new Color(91, 157, 171));
//
//        // 画一个圆角矩形
//
//        // 这里面前四个参数就不多讲了，坐标和宽高
